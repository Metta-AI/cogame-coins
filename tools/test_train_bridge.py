"""Exercise every certified Coins variant through its JSONL training bridge."""
...
for variant in ("standard", "long-shadow", "short-fuse", "harsh", "scarce"):
    with subprocess.Popen(
        ...
        while observation["kind"] == "decision":
            ...
            assert len(encoded["values"]) == 32 and len(encoded["actions"]) == 5
            ...
            decisions += 1
        assert decisions > 0 and decisions % 2 == 0
